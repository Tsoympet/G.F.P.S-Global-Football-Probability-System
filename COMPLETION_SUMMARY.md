...
- Implemented provider registry + odds abstraction with free-only default, hybrid/premium modes, OpenLigaDB/Football-Data.org adapters, and compliance docs (provider matrix, premium enablement, legal guardrails).
